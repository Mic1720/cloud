...
namespace Web.Controllers
{
    public class ItensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,NomePersonagem,Detalhes,Vida,Dano,Hostil,TipoItemID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,NomePersonagem,Detalhes,Vida,Dano,Hostil,TipoItemID")] Item item)
        {
            if (ModelState.IsValid)
            {
